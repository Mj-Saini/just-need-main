            ...
            <ul className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium">
                        {user.firstName || user.user_detail?.firstName || "N/A"}{" "}
                        {user.lastName || user.user_detail?.lastName || ""}
                        {user.user_detail?.firstName &&
                          (user.firstName !== user.user_detail.firstName ||
                            user.lastName !== user.user_detail.lastName) }
                      </p>
                  ...
                  <button
                    ...
                    onClick={() => onUnblock(user.userId || user.id)}
                  >
                    Unblock
                  </button>
                </li>
